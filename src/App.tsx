...
function App() {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      link.download = 'barca-tier-list.png';
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: 'My FC Barcelona Tier List',
          text: 'Check out my FC Barcelona player tier list!',
        ...
        <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-8">
          <header className="text-center mb-6 sm:mb-8">
            <h1 className="text-3xl sm:text-4xl font-bold text-white mb-2 sm:mb-4">
              FC Barcelona Player Tier List
            </h1>
            <p className="text-gray-200 mb-4 sm:mb-6 px-4">
              Drag and drop players to create your ultimate Barça tier list
            </p>
